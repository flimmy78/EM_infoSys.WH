...
{	struct soap *soap = this;
	...
	if (soap_endpoint == NULL)
		soap_endpoint = "http://10.158.249.196:7001/InterfaceWS/InterfaceBusiness/services/DetectService";
	if (soap_action == NULL)
		soap_action = "";
	soap_begin(soap);
...
int DetectServiceHttpBindingProxy::validDetectRslt(const char *endpoint, const char *soap_action, _ns1__validDetectRslt *ns1__validDetectRslt, _ns1__validDetectRsltResponse &ns1__validDetectRsltResponse)
{	struct soap *soap = this;
	struct __ns1__validDetectRslt soap_tmp___ns1__validDetectRslt;
	if (endpoint)
		soap_endpoint = endpoint;
	if (soap_endpoint == NULL)
		soap_endpoint = "http://10.158.249.196:7001/InterfaceWS/InterfaceBusiness/services/DetectService";
	...
	soap_begin(soap);
	soap->encodingStyle = NULL;
	soap_tmp___ns1__validDetectRslt.ns1__validDetectRslt = ns1__validDetectRslt;
	soap_serializeheader(soap);
	soap_serialize___ns1__validDetectRslt(soap, &soap_tmp___ns1__validDetectRslt);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns1__validDetectRslt(soap, &soap_tmp___ns1__validDetectRslt, "-ns1:validDetectRslt", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
	...
	if (soap_connect(soap, soap_url(soap, soap_endpoint, NULL), soap_action)
	 ...
	 || soap_end_send(soap))
		return soap_closesock(soap);
	if (!&ns1__validDetectRsltResponse)
		return soap_closesock(soap);
	ns1__validDetectRsltResponse.soap_default(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	ns1__validDetectRsltResponse.soap_get(soap, "ns1:validDetectRsltResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
