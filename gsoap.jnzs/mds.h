/* mds.h
   Generated by wsdl2h 2.8.21 from http://10.158.249.196:7001/InterfaceWS/InterfaceBusiness/services/DetectService?wsdl and typemap.dat
   2015-08-24 07:31:22 GMT
...
//  Forward declaration of class _ns1__validDetectRslt.
class _ns1__validDetectRslt;

//  Forward declaration of class _ns1__validDetectRsltResponse.
class _ns1__validDetectRsltResponse;
...
/// @brief Top-level root element "http://webservice.mpac.nari.com":validDetectRslt
/// @brief "http://webservice.mpac.nari.com":validDetectRslt is a complexType.
///
/// class _ns1__validDetectRslt operations:
/// - soap_new__ns1__validDetectRslt(soap*) allocate
/// - soap_new__ns1__validDetectRslt(soap*, int num) allocate array
/// - soap_new_req__ns1__validDetectRslt(soap*, ...) allocate, set required members
/// - soap_new_set__ns1__validDetectRslt(soap*, ...) allocate, set all public members
/// - int soap_read__ns1__validDetectRslt(soap*, _ns1__validDetectRslt*) deserialize from a stream
/// - int soap_write__ns1__validDetectRslt(soap, _ns1__validDetectRslt*) serialize to a stream
class _ns1__validDetectRslt
{ public:
/// Element "in0" of XSD type xs:string.
    std::string*                         in0                            1;	///< Nillable pointer.
...
/// @brief Top-level root element "http://webservice.mpac.nari.com":validDetectRsltResponse
/// @brief "http://webservice.mpac.nari.com":validDetectRsltResponse is a complexType.
///
/// class _ns1__validDetectRsltResponse operations:
/// - soap_new__ns1__validDetectRsltResponse(soap*) allocate
/// - soap_new__ns1__validDetectRsltResponse(soap*, int num) allocate array
/// - soap_new_req__ns1__validDetectRsltResponse(soap*, ...) allocate, set required members
/// - soap_new_set__ns1__validDetectRsltResponse(soap*, ...) allocate, set all public members
/// - int soap_read__ns1__validDetectRsltResponse(soap*, _ns1__validDetectRsltResponse*) deserialize from a stream
/// - int soap_write__ns1__validDetectRsltResponse(soap, _ns1__validDetectRsltResponse*) serialize to a stream
class _ns1__validDetectRsltResponse
{ public:
/// Element "out" of XSD type xs:string.
    std::string*                         out                            1;	///< Nillable pointer.
...
//gsoap ns1  service port:	http://10.158.249.196:7001/InterfaceWS/InterfaceBusiness/services/DetectService 
...
@section DetectServiceHttpBinding_ports Endpoints of Binding "DetectServiceHttpBinding"
  ...
  - http://10.158.249.196:7001/InterfaceWS/InterfaceBusiness/services/DetectService
 ...
 *                                                                            *
 * Service Operation                                                          *
 *   __ns1__validDetectRslt                                                   *
 *                                                                            *
\******************************************************************************/


/** Operation "__ns1__validDetectRslt" of service binding "DetectServiceHttpBinding".
...
C stub function (defined in soapClient.c[pp] generated by soapcpp2):
@code
  int soap_call___ns1__validDetectRslt(
    struct soap *soap,
    NULL, // char *endpoint = NULL selects default endpoint for this operation
    NULL, // char *action = NULL selects default action for this operation
    // input parameters:
    _ns1__validDetectRslt*              ns1__validDetectRslt,
    // output parameters:
    _ns1__validDetectRsltResponse      &ns1__validDetectRsltResponse
  );
@endcode

C server function (called from the service dispatcher defined in soapServer.c[pp]):
@code
  int __ns1__validDetectRslt(
    struct soap *soap,
    // input parameters:
    _ns1__validDetectRslt*              ns1__validDetectRslt,
    // output parameters:
...
//gsoap ns1  service method-protocol:	validDetectRslt SOAP
//gsoap ns1  service method-style:	validDetectRslt document
//gsoap ns1  service method-encoding:	validDetectRslt literal
//gsoap ns1  service method-action:	validDetectRslt ""
//gsoap ns1  service method-output-action:	validDetectRslt Response
int __ns1__validDetectRslt(
    _ns1__validDetectRslt*              ns1__validDetectRslt,	///< Input parameter
    _ns1__validDetectRsltResponse      &ns1__validDetectRsltResponse	///< Output parameter
);
...
@section ns1 Top-level root elements of schema "http://webservice.mpac.nari.com"
  ...
  - <validDetectRslt> @ref _ns1__validDetectRslt
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__validDetectRslt(struct soap*, _ns1__validDetectRslt*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__validDetectRslt(struct soap*, _ns1__validDetectRslt*);
    @endcode

  - <validDetectRsltResponse> @ref _ns1__validDetectRsltResponse
    @code
    // Reader (returns SOAP_OK on success):
    soap_read__ns1__validDetectRsltResponse(struct soap*, _ns1__validDetectRsltResponse*);
    // Writer (returns SOAP_OK on success):
    soap_write__ns1__validDetectRsltResponse(struct soap*, _ns1__validDetectRsltResponse*);
    @endcode
