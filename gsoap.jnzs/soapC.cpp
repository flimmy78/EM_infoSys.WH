...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.21 2015-08-24 07:31:23 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_PointerTo_ns1__validDetectRslt:
		return soap_in_PointerTo_ns1__validDetectRslt(soap, NULL, NULL, "ns1:validDetectRslt");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		if (!soap_match_tag(soap, t, "ns1:validDetectRsltResponse"))
		{	*type = SOAP_TYPE__ns1__validDetectRsltResponse;
			return soap_in__ns1__validDetectRsltResponse(soap, NULL, NULL, NULL);
		}
		if (!soap_match_tag(soap, t, "ns1:validDetectRslt"))
		{	*type = SOAP_TYPE__ns1__validDetectRslt;
			return soap_in__ns1__validDetectRslt(soap, NULL, NULL, NULL);
		}
...
{	(void)tag;
	...
	case SOAP_TYPE__ns1__validDetectRsltResponse:
		return ((_ns1__validDetectRsltResponse *)ptr)->soap_out(soap, "ns1:validDetectRsltResponse", id, NULL);
	case SOAP_TYPE__ns1__validDetectRslt:
		return ((_ns1__validDetectRslt *)ptr)->soap_out(soap, "ns1:validDetectRslt", id, NULL);
	...
	case SOAP_TYPE_PointerTo_ns1__validDetectRslt:
		return soap_out_PointerTo_ns1__validDetectRslt(soap, tag, id, (_ns1__validDetectRslt *const*)ptr, "ns1:validDetectRslt");
	case SOAP_TYPE_PointerTo_ns1__equipCheckInfo:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE__ns1__boxCheckInfo:
		...
		break;
	case SOAP_TYPE__ns1__validDetectRsltResponse:
		((_ns1__validDetectRsltResponse *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE__ns1__validDetectRslt:
		((_ns1__validDetectRslt *)ptr)->soap_serialize(soap);
		break;
	case SOAP_TYPE__ns1__equipCheckInfoResponse:
	...
	case SOAP_TYPE___ns1__boxCheckInfo:
		...
		break;
	case SOAP_TYPE___ns1__validDetectRslt:
		soap_serialize___ns1__validDetectRslt(soap, (const struct __ns1__validDetectRslt *)ptr);
		break;
	...
	case SOAP_TYPE_PointerTo_ns1__boxCheckInfo:
		...
		break;
	case SOAP_TYPE_PointerTo_ns1__validDetectRslt:
		soap_serialize_PointerTo_ns1__validDetectRslt(soap, (_ns1__validDetectRslt *const*)ptr);
		break;
	case SOAP_TYPE_PointerTo_ns1__equipCheckInfo:
...
{	(void)type;
	...
	case SOAP_TYPE__ns1__validDetectRslt:
		return (void*)soap_instantiate__ns1__validDetectRslt(soap, -1, type, arrayType, n);
	case SOAP_TYPE__ns1__validDetectRsltResponse:
		return (void*)soap_instantiate__ns1__validDetectRsltResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE__ns1__boxCheckInfo:
	...
	case SOAP_TYPE___ns1__validDetectRslt:
		return (void*)soap_instantiate___ns1__validDetectRslt(soap, -1, type, arrayType, n);
	case SOAP_TYPE___ns1__boxCheckInfo:
...
{	switch (p->type)
	...
	case SOAP_TYPE__ns1__validDetectRslt:
		if (p->size < 0)
			SOAP_DELETE((_ns1__validDetectRslt*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__validDetectRslt*)p->ptr);
		break;
	case SOAP_TYPE__ns1__validDetectRsltResponse:
		if (p->size < 0)
			SOAP_DELETE((_ns1__validDetectRsltResponse*)p->ptr);
		else
			SOAP_DELETE_ARRAY((_ns1__validDetectRsltResponse*)p->ptr);
		break;
	case SOAP_TYPE__ns1__boxCheckInfo:
		if (p->size < 0)
	...
	case SOAP_TYPE___ns1__validDetectRslt:
		if (p->size < 0)
			SOAP_DELETE((struct __ns1__validDetectRslt*)p->ptr);
		else
			SOAP_DELETE_ARRAY((struct __ns1__validDetectRslt*)p->ptr);
		break;
	case SOAP_TYPE___ns1__boxCheckInfo:
		if (p->size < 0)
...
void _ns1__validDetectRsltResponse::soap_default(struct soap *soap)
{
	this->soap = soap;
	this->_ns1__validDetectRsltResponse::out = NULL;
	/* transient soap skipped */
}

void _ns1__validDetectRsltResponse::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__string(soap, &this->_ns1__validDetectRsltResponse::out);
	/* transient soap skipped */
#endif
}

int _ns1__validDetectRsltResponse::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out__ns1__validDetectRsltResponse(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__validDetectRsltResponse(struct soap *soap, const char *tag, int id, const _ns1__validDetectRsltResponse *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__validDetectRsltResponse), type))
		return soap->error;
	if (a->out)
		soap_element_result(soap, "ns1:out");
	if (a->_ns1__validDetectRsltResponse::out)
	{	if (soap_out_PointerTostd__string(soap, "ns1:out", -1, &a->_ns1__validDetectRsltResponse::out, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "ns1:out"))
		return soap->error;
...
void *_ns1__validDetectRsltResponse::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in__ns1__validDetectRsltResponse(soap, tag, this, type);
}

SOAP_FMAC3 _ns1__validDetectRsltResponse * SOAP_FMAC4 soap_in__ns1__validDetectRsltResponse(struct soap *soap, const char *tag, _ns1__validDetectRsltResponse *a, const char *type)
{
	(void)tag; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (_ns1__validDetectRsltResponse *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE__ns1__validDetectRsltResponse, sizeof(_ns1__validDetectRsltResponse), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	if (soap->alloced)
	{	a->soap_default(soap);
		if (soap->clist->type != SOAP_TYPE__ns1__validDetectRsltResponse)
		{	soap_revert(soap);
			*soap->id = '\0';
			return (_ns1__validDetectRsltResponse *)a->soap_in(soap, tag, type);
		}
	}
	size_t soap_flag_out1 = 1;
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_out1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "ns1:out", &(a->_ns1__validDetectRsltResponse::out), "xsd:string"))
				{	soap_flag_out1--;
					continue;
				}
			/* transient soap skipped */
	...
	{	a = (_ns1__validDetectRsltResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__ns1__validDetectRsltResponse, 0, sizeof(_ns1__validDetectRsltResponse), 0, soap_copy__ns1__validDetectRsltResponse);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_out1 > 0))
...
int _ns1__validDetectRsltResponse::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, SOAP_TYPE__ns1__validDetectRsltResponse);
	if (this->soap_out(soap, tag?tag:"ns1:validDetectRsltResponse", id, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *_ns1__validDetectRsltResponse::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get__ns1__validDetectRsltResponse(soap, this, tag, type);
}

SOAP_FMAC3 _ns1__validDetectRsltResponse * SOAP_FMAC4 soap_get__ns1__validDetectRsltResponse(struct soap *soap, _ns1__validDetectRsltResponse *p, const char *tag, const char *type)
{
	if ((p = soap_in__ns1__validDetectRsltResponse(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 _ns1__validDetectRsltResponse * SOAP_FMAC2 soap_instantiate__ns1__validDetectRsltResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate__ns1__validDetectRsltResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE__ns1__validDetectRsltResponse, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__validDetectRsltResponse);
		if (size)
			*size = sizeof(_ns1__validDetectRsltResponse);
		((_ns1__validDetectRsltResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__validDetectRsltResponse, n);
		if (size)
			*size = n * sizeof(_ns1__validDetectRsltResponse);
		if (cp->ptr)
			for (int i = 0; i < n; i++)
				((_ns1__validDetectRsltResponse*)cp->ptr)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (_ns1__validDetectRsltResponse*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__validDetectRsltResponse(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying _ns1__validDetectRsltResponse %p -> %p\n", q, p));
	*(_ns1__validDetectRsltResponse*)p = *(_ns1__validDetectRsltResponse*)q;
}

void _ns1__validDetectRslt::soap_default(struct soap *soap)
{
	this->soap = soap;
	this->_ns1__validDetectRslt::in0 = NULL;
	/* transient soap skipped */
}

void _ns1__validDetectRslt::soap_serialize(struct soap *soap) const
{
	(void)soap; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTostd__string(soap, &this->_ns1__validDetectRslt::in0);
	/* transient soap skipped */
#endif
}

int _ns1__validDetectRslt::soap_out(struct soap *soap, const char *tag, int id, const char *type) const
{
	return soap_out__ns1__validDetectRslt(soap, tag, id, this, type);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__validDetectRslt(struct soap *soap, const char *tag, int id, const _ns1__validDetectRslt *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE__ns1__validDetectRslt), type))
		return soap->error;
	if (a->_ns1__validDetectRslt::in0)
	{	if (soap_out_PointerTostd__string(soap, "ns1:in0", -1, &a->_ns1__validDetectRslt::in0, ""))
			return soap->error;
	}
	else if (soap_element_nil(soap, "ns1:in0"))
		return soap->error;
...
void *_ns1__validDetectRslt::soap_in(struct soap *soap, const char *tag, const char *type)
{	return soap_in__ns1__validDetectRslt(soap, tag, this, type);
}

SOAP_FMAC3 _ns1__validDetectRslt * SOAP_FMAC4 soap_in__ns1__validDetectRslt(struct soap *soap, const char *tag, _ns1__validDetectRslt *a, const char *type)
{
	(void)tag; (void)type; /* appease -Wall -Werror */
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	a = (_ns1__validDetectRslt *)soap_class_id_enter(soap, soap->id, a, SOAP_TYPE__ns1__validDetectRslt, sizeof(_ns1__validDetectRslt), soap->type, soap->arrayType);
	if (!a)
		return NULL;
	if (soap->alloced)
	{	a->soap_default(soap);
		if (soap->clist->type != SOAP_TYPE__ns1__validDetectRslt)
		{	soap_revert(soap);
			*soap->id = '\0';
			return (_ns1__validDetectRslt *)a->soap_in(soap, tag, type);
		}
	}
	size_t soap_flag_in01 = 1;
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_in01 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "ns1:in0", &(a->_ns1__validDetectRslt::in0), "xsd:string"))
				{	soap_flag_in01--;
					continue;
				}
			/* transient soap skipped */
	...
	{	a = (_ns1__validDetectRslt *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE__ns1__validDetectRslt, 0, sizeof(_ns1__validDetectRslt), 0, soap_copy__ns1__validDetectRslt);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_in01 > 0))
...
int _ns1__validDetectRslt::soap_put(struct soap *soap, const char *tag, const  char *type) const
{
	register int id = soap_embed(soap, (void*)this, NULL, 0, SOAP_TYPE__ns1__validDetectRslt);
	if (this->soap_out(soap, tag?tag:"ns1:validDetectRslt", id, type))
		return soap->error;
	return soap_putindependent(soap);
}

void *_ns1__validDetectRslt::soap_get(struct soap *soap, const char *tag, const char *type)
{
	return soap_get__ns1__validDetectRslt(soap, this, tag, type);
}

SOAP_FMAC3 _ns1__validDetectRslt * SOAP_FMAC4 soap_get__ns1__validDetectRslt(struct soap *soap, _ns1__validDetectRslt *p, const char *tag, const char *type)
{
	if ((p = soap_in__ns1__validDetectRslt(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 _ns1__validDetectRslt * SOAP_FMAC2 soap_instantiate__ns1__validDetectRslt(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate__ns1__validDetectRslt(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE__ns1__validDetectRslt, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(_ns1__validDetectRslt);
		if (size)
			*size = sizeof(_ns1__validDetectRslt);
		((_ns1__validDetectRslt*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(_ns1__validDetectRslt, n);
		if (size)
			*size = n * sizeof(_ns1__validDetectRslt);
		if (cp->ptr)
			for (int i = 0; i < n; i++)
				((_ns1__validDetectRslt*)cp->ptr)[i].soap = soap;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (_ns1__validDetectRslt*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy__ns1__validDetectRslt(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying _ns1__validDetectRslt %p -> %p\n", q, p));
	*(_ns1__validDetectRslt*)p = *(_ns1__validDetectRslt*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default___ns1__validDetectRslt(struct soap *soap, struct __ns1__validDetectRslt *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	a->ns1__validDetectRslt = NULL;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_serialize___ns1__validDetectRslt(struct soap *soap, const struct __ns1__validDetectRslt *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_PointerTo_ns1__validDetectRslt(soap, &a->ns1__validDetectRslt);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out___ns1__validDetectRslt(struct soap *soap, const char *tag, int id, const struct __ns1__validDetectRslt *a, const char *type)
{
	(void)soap; (void)tag; (void)id; (void)a; (void)type; /* appease -Wall -Werror */
	if (soap_out_PointerTo_ns1__validDetectRslt(soap, "ns1:validDetectRslt", -1, &a->ns1__validDetectRslt, ""))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__validDetectRslt * SOAP_FMAC4 soap_in___ns1__validDetectRslt(struct soap *soap, const char *tag, struct __ns1__validDetectRslt *a, const char *type)
{
	size_t soap_flag_ns1__validDetectRslt = 1;
	short soap_flag;
	(void)tag; (void)type; /* appease -Wall -Werror */
	a = (struct __ns1__validDetectRslt *)soap_id_enter(soap, "", a, SOAP_TYPE___ns1__validDetectRslt, sizeof(struct __ns1__validDetectRslt), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	soap_default___ns1__validDetectRslt(soap, a);
		for (soap_flag = 0;; soap_flag = 1)
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_ns1__validDetectRslt && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerTo_ns1__validDetectRslt(soap, "ns1:validDetectRslt", &a->ns1__validDetectRslt, ""))
				{	soap_flag_ns1__validDetectRslt--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
				if (soap_flag)
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put___ns1__validDetectRslt(struct soap *soap, const struct __ns1__validDetectRslt *a, const char *tag, const char *type)
{
	register int id = 0;
	if (soap_out___ns1__validDetectRslt(soap, tag?tag:"-ns1:validDetectRslt", id, a, type))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC3 struct __ns1__validDetectRslt * SOAP_FMAC4 soap_get___ns1__validDetectRslt(struct soap *soap, struct __ns1__validDetectRslt *p, const char *tag, const char *type)
{
	if ((p = soap_in___ns1__validDetectRslt(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}

SOAP_FMAC1 struct __ns1__validDetectRslt * SOAP_FMAC2 soap_instantiate___ns1__validDetectRslt(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate___ns1__validDetectRslt(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE___ns1__validDetectRslt, n, soap_fdelete);
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)SOAP_NEW(struct __ns1__validDetectRslt);
		if (size)
			*size = sizeof(struct __ns1__validDetectRslt);
	}
	else
	{	cp->ptr = (void*)SOAP_NEW_ARRAY(struct __ns1__validDetectRslt, n);
		if (size)
			*size = n * sizeof(struct __ns1__validDetectRslt);
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated location=%p\n", cp->ptr));
	if (!cp->ptr)
		soap->error = SOAP_EOM;
	return (struct __ns1__validDetectRslt*)cp->ptr;
}

SOAP_FMAC3 void SOAP_FMAC4 soap_copy___ns1__validDetectRslt(struct soap *soap, int st, int tt, void *p, size_t len, const void *q, size_t n)
{
	(void)soap; (void)tt; (void)st; (void)len; (void)n; /* appease -Wall -Werror */
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copying struct __ns1__validDetectRslt %p -> %p\n", q, p));
	*(struct __ns1__validDetectRslt*)p = *(struct __ns1__validDetectRslt*)q;
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerTo_ns1__validDetectRslt(struct soap *soap, _ns1__validDetectRslt *const*a)
{
#ifndef WITH_NOIDREF
	if (!soap_reference(soap, *a, SOAP_TYPE__ns1__validDetectRslt))
		(*a)->soap_serialize(soap);
#endif
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerTo_ns1__validDetectRslt(struct soap *soap, const char *tag, int id, _ns1__validDetectRslt *const*a, const char *type)
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE__ns1__validDetectRslt);
	if (id < 0)
		return soap->error;
	return (*a)->soap_out(soap, tag, id, type);
}

SOAP_FMAC3 _ns1__validDetectRslt ** SOAP_FMAC4 soap_in_PointerTo_ns1__validDetectRslt(struct soap *soap, const char *tag, _ns1__validDetectRslt **a, const char *type)
{
	(void)type; /* appease -Wall -Werror */
	...
	if (soap_element_begin_in(soap, tag, 1, NULL))
		return NULL;
	if (!a)
		if (!(a = (_ns1__validDetectRslt **)soap_malloc(soap, sizeof(_ns1__validDetectRslt *))))
			return NULL;
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		if (!(*a = (_ns1__validDetectRslt *)soap_instantiate__ns1__validDetectRslt(soap, -1, soap->type, soap->arrayType, NULL)))
			return NULL;
		(*a)->soap_default(soap);
		if (!(*a)->soap_in(soap, tag, NULL))
			return NULL;
	...
	{	_ns1__validDetectRslt ** p = (_ns1__validDetectRslt **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE__ns1__validDetectRslt, sizeof(_ns1__validDetectRslt), 0);
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__validDetectRslt(struct soap *soap, _ns1__validDetectRslt *const*a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, SOAP_TYPE_PointerTo_ns1__validDetectRslt);
	if (soap_out_PointerTo_ns1__validDetectRslt(soap, tag?tag:"ns1:validDetectRslt", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 _ns1__validDetectRslt ** SOAP_FMAC4 soap_get_PointerTo_ns1__validDetectRslt(struct soap *soap, _ns1__validDetectRslt **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerTo_ns1__validDetectRslt(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
